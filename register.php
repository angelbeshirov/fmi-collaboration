...
<body id="gradient">
	...
	<section class="main-container">
		<form id="register-form">
			...
			<div class="input-container">
				<input class="field-input" id="username" name="username" type="text" placeholder="Потребителско име" required></input>
				<div class="error"></div>
			</div>
			<div class="input-container">
			...
			<div class="input-container">
				<input class="field-input" id="password-repeat" name="password-repeat" type="password" placeholder="Повторете паролата" required></input>
				<div class="error"></div>
			</div>
			<div class="input-container">
				<div class="message"></div>
				<input id="register" class="btn" type="submit" value="Регистрация"></input>
			</div>
		</form>
	</section>
</body>
